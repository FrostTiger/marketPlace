...
var Product = require('../chat/user/product');
...
var owner = {
    ...
    products: [new Product('Bardak', '2.00'), new Product('Ekmek', '1.25'), new Product('Makarna', '3.00'),
    new Product('Kaşık', '5.00'), new Product('Masa', '28.00'), new Product('Kaşar', '11.00'),
    new Product('Sucuk', '29.00'), new Product('Salam', '28.00'), new Product('Su', '0.50'), new Product('Diş fırçası', '2.00'),
    new Product('Diş macunu', '4.00'), new Product('Deterjan', '32.00'), new Product('Et', '42.00'), new Product('Karanfil', '0.25'),
    new Product('Mantar', '9.00'), new Product('Kazak', '65.00'), new Product('Gözlük', '500.00'), new Product('Havlu', '21.00'),
    new Product('Tavuk', '21.00'), new Product('Lahana', '7.00'), new Product('Ispanak', '4.00'), new Product('Yumurta', '2.00'),
    new Product('Çay', '3.00'), new Product('Salça', '12.00'), new Product('Maden suyu', '1.00'), new Product('Kola', '3.00'),
    new Product('Muz', '8.00'), new Product('Elma', '3.00'), new Product('Pirinç', '25.00'), new Product('Mayonez', '20.00')]
...
getOwner = () => [200, owner];
getScreenTypes = () => [250, ScreenTypes];
module.exports = {
    getThreads,
    getUpdates,
    getOwner,
